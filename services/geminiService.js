...
const arjunKnowledgeBase = `
    ...
    He can be found on:
    - LinkedIn: https://www.linkedin.com/in/arjun-pratap-6132941a6/
    - GitHub: https://github.com/arjunprratap05
    - Instagram: https://www.instagram.com/arjun.prratap05/
    - Portfolio (URL not explicitly provided in documents, but mentioned in resume contacts) 
    ...
    **Projects:**
    - **GitHub Profile Detective (ReactJS, Node.js, Vite, CSS, JavaScript) - Sep 2022 - Present:** Developed a web application to search and display GitHub user profiles, providing insights into their activity. (Further features for Instagram planned). 
    - **Portfolio Website (ReactJS, Node.js, Vite, CSS, Google GenerativeAI, JavaScript) - Feb 2025 - June 2025:** Created a responsive developer portfolio featuring downloadable CV, API-integrated contact form, and live social links. Used AI prompts to enhance UX writing and developer content. 
    ...
    - **Mega Blog Clone (ReactJS, Vite, Appwrite) - Feb 2024 - Jul 2024:** Built a modular blogging platform with AI-assisted formatting and content publishing. 
